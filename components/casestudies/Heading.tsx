  ...
  return (
    <>
      <section className="casehead mx-auto flex w-[21rem] flex-col md:w-[41.125rem]">
        <h1 className="casetitle dark:text-white">
          <span className="underline-magic w-full"> My Portfolio </span>
        </h1>
        <p className="smallreg flex pt-[1.25rem] text-center text-slate dark:text-white1 md:px-[2rem] md:pt-[1.8rem]">
