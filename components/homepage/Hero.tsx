...
const Hero = () => {
  return (
    <div className="mx-[.33rem] flex w-fit flex-col justify-center bg-white1 pb-[2rem] pt-[3rem] dark:bg-darkbg xs:mx-auto xs:max-w-[21.5rem] ss:max-w-[25rem] sm:max-w-[38rem] md:max-w-[63rem] md:flex-row lg:max-w-[75rem] xl:max-w-[100rem]">
