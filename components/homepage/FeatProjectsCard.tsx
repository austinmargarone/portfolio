...
const FeatProjectsCard = (props: Props) => {
  return (
    <div className="mx-auto flex h-[32.125rem] w-full flex-col rounded-[1rem] border bg-slate md:h-[27.75rem] md:flex-row">
      <div className=" mx-auto flex flex-col">
        <h3 className="projecttitle mt-[2.5rem] w-[18.4375rem] text-left text-white md:mt-[6.06rem] md:w-[23.25rem]">
