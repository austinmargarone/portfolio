...
const MySkills = () => {
  return (
    <section className="mx-auto flex w-fit max-w-[21.5rem] flex-col justify-center pb-[2rem] pt-[3rem] ss:max-w-[25rem] sm:max-w-[40rem] md:max-w-[65rem] md:flex-row xl:max-w-[90rem]">
